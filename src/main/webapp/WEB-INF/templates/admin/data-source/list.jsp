        ...
        <div class="container">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <c:if test="${flashMessage == 'data-source-saved'}">
                        <div class="alert alert-success flash-message">数据源已经保存</div>
                    </c:if>
                    <c:if test="${flashMessage == 'data-source-deleted'}">
                        <div class="alert alert-success flash-message">数据源已经删除</div>
                    </c:if>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>${ds.name}</td>
                                <td>${ds.internalName}</td>
                                <td class="row-actions">
                                    <a class="btn btn-primary" href="/admin/data-sources/${ds.id}">
                                        <span class="glyphicon glyphicon-pencil"></span>
                                    </a>
                                    <a class="btn btn-danger action-btn" data-action-url="/admin/data-sources/${ds.id}/delete"
                                        data-action-desc="删除数据源：${ds.name}" data-action-name="删除"
                                        data-action-msg="确认要删除该数据源吗？">
                ...
                <div class="panel-footer">
                    <a class="btn btn-primary" href="/admin/monitors/${parent.id}/data-sources/new">创建数据源</a>
