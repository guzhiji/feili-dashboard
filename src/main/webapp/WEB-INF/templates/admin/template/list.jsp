        ...
        <div class="container">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <c:if test="${flashMessage == 'template-saved'}">
                        <div class="alert alert-success flash-message">模板已经保存</div>
                    </c:if>
                    <c:if test="${flashMessage == 'template-deleted'}">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="row-actions">
                                    ...
                                    <a class="btn btn-danger action-btn" data-action-url="/admin/templates/${tpl.id}/delete"
                                        data-action-desc="删除模板：${tpl.name}" data-action-name="删除"
                                        data-action-msg="确认要删除该模板吗？">
